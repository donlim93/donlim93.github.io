...
\begin{itemize}
    ...
    \begin{itemize}
        \item Frameworks/Languages/Tools used: R (dplyr, tidyr, stringr, ggplot2), Stata, Matlab, Python, SAS, \LaTeX
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Frameworks/Languages/Tools used: MySQL, PHP, JavaScript, jQuery, JSON, XAMPP
    \end{itemize}
    ...
    \begin{itemize}
        \item Frameworks/Languages/Tools used: Python (regex, numpy, pandas, scikit-learn, matplotlib, seaborn, nltk, networkx)
        \item Frameworks/Languages/Tools used: Gradient descent, random forest, decision tree, SVC, linear and logistic regression, lasso, KNN, na\"{i}ve Bayes, clustering
    \end{itemize}
    ...
    \begin{itemize}
        \item Frameworks/Languages/Tools used: Django, SQLite3, HTML5, CSS, JavaScript, Bash
    \end{itemize}
