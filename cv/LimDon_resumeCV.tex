...
\usepackage[margin=0.825in]{geometry}
\textheight=10in
\pagestyle{empty}
\raggedright
...
\begin{itemize}
    ...
    \item Developing IBM TM1/Planning Analytics processes and business rules for financial reporting and forecasting (TurboIntegrator, MDX)
\end{itemize}
\vspace{1mm}
