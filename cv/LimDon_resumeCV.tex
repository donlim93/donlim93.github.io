...
\begin{itemize}
    ...
    \item Programmatically creating and manipulating 42 cubes, 88 dimensions, attributes, subsets, control objects, security, applications, and views in IBM TM1/Planning Analytics development, UAT, and production environments using mutlidimensional expressions (MDX), SQL, TurboIntegrator (TI) processes, and TM1 rules
