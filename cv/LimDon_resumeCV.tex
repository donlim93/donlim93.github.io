...
\begin{center}
    ...
    \href{mailto:lim.don93@gmail.com}{\Letter\space lim.don93@gmail.com} \ding{118} \Mobilefone\space (806) 317-7937 \ding{118} \href{https://donlim93.github.io/}{\faGlobe\space donlim93.github.io} \ding{118} \faMapMarker\space Frisco, Texas \\
\end{center}
%==== Experience ====%
\vspace*{-2mm}
...
\begin{itemize}
    ...
    \item Maintained non-clustered SQL relational databases (querying tables, SSL certs, TLS config, etc.)
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Statistical methods:} OLS, IV, TWFE, DiD, 2SDiD, RDD, matching (propensity score, kernel, entropy, Mahalanobis distance,  nearest-neighbor), synthetic control, event study, factor and cluster analysis, logit/probit
    \end{itemize}
\end{itemize}
\vspace{1mm}
