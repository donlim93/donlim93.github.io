...
\begin{itemize}
    ...
    \item Loading and transforming job scrub, GL, and budget data from ODBC SQL connections while developing and maintaining cash flow, KPIs, and milestone reporting for the finance and accounting team
\end{itemize}
