...
\begin{itemize}
    ...
    \item Extracting, transforming, and loading (ETL) job scrub, GL, and budget data from ODBC SQL connections while developing automated calculations for actual and forecasted cash flows, KPIs, and milestones for financial models and reporting 
\end{itemize}
\vspace{0.5mm}
