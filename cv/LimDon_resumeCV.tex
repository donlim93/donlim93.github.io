...
\begin{itemize}
    \item Troubleshooted Laserfiche automated workflows, quick fields, and forms processes
    \item Maintained non-clustered SQL relational databases
    \item Administered folder-, document-, and user-level security using admin consoles and AD
