...
\textit{Sales and Marketing Analyst, IT} \hfill  \emph{May 2023 --- Present} \\
\begin{itemize}
    \item Developing IBM TM1/Planning Analytics TI processes and business rules for financial planning and analysis (PAW, PAfE, ETL, MDX, Cognos Command Center, Arc, Pulse)
    \item Creating and maintaining cubes, dimensions, subsets, and views in TM1 development, UAT, and production 
    \item Implementing, testing, and training Salesforce development, UAT, and production environments for 200 users (Salesforce CRM, Marketing Cloud, Sales Cloud, Data Loader) 
