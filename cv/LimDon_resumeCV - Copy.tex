...
\begin{itemize}
    \item Assisting in implementing Salesforce development, UAT, and production environments (Salesforce CRM, Marketing Cloud, Sales Cloud); querying existing data to validate and clean for migration into Salesforce (SQL, Python)
\end{itemize}
\vspace{0.5mm}
