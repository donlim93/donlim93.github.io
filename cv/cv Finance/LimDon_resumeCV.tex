...
\begin{itemize}
    \item Troubleshot, built, and tested Laserfiche application suite for document lifecycle management, including Quick Fields, Workflow, and Form processes, which OCR, extract, route, classify, retain, and secure documents for clients in legal, corporate, and independent school districts
